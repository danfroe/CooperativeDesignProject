...
mHydrogen_stream6 = sd.nHydrogen_stream6 * MW_H2 # kg/h
mMethane_stream6 = sd.nMethane_stream6 * MW_Methane # kg/h
T_fuel = sd.T_stream6                  
...
sol = fsolve(energybalancesfurnace, [100,100,100,100], \
             args=(T_ambient,T_fuel,sd.T_fluegasOut,Q_H101,mHydrogen_stream6,mMethane_stream6))
...
print('Mass flow of fuel gas into feed heater H-101: %.2f [kg/h]' % m_fuelgas_furnaceIn) # value much too low, should be ~ 846 000 kg/h according to book
